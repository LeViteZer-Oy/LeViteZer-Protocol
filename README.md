...
#### Exposure (us) (grouped)
Exposure time in microseconds. Signed 32 bit parameter divided in 2 ids. <br>
Min value 1. <br>
Max value 42000. <br>
...
Shutter angle in degrees, multiplied by 100. Signed 32 bit parameter divided in 2 Ids. <br>
Min value 100. <br>
Max value 36000. <br>
| Id  |                 name                   |  min   | max    |                                  Observations                          | BMD Id |
|:---:|----------------------------------------|:------:|:------:|------------------------------------------------------------------------|:------:|
...
Value as a fraction of 1, i.g 50 for 1/50th of a second. Signed 32 bit parameter divided in 2 ids. <br>
Min value 24. <br>
Max value 2000. <br>
| Id  |                 name                   |  min   | max    |                                  Observations                          | BMD Id |
|:---:|----------------------------------------|:------:|:------:|------------------------------------------------------------------------|:------:|
...
#### ISO (grouped)
ISO value. Signed 32 bit parameter divided in 2 ids. <br>
Min value 0. <br>
