...
each 'DD' is a byte of data. The data bytes are between a sequence of numbers as shown above. The first two bytes of data `MM MM` after `01` are a 16 bit integer Id that identifies the data. Note that the first byte of data is after `02`
